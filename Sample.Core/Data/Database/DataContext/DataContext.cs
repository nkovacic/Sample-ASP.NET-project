...
namespace Sample.Core.Data.Database
{
    ...
    public class DataContext : DbContext, IDataContextAsync
    {
        ...
        public DataContext() : this("DbContext") { }
        ...
        {
            if (!Configuration.ProxyCreationEnabled)
            {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            foreach (var assembly in AppDomain.CurrentDomain.GetAssemblies().Where(a => !a.FullName.Contains("System")))
            {
                var typesToRegister = assembly
                    .GetTypes()
                    .Where(type => type.BaseType != null && type.BaseType.IsGenericType && type.BaseType.GetGenericTypeDefinition() == typeof(EntityTypeConfiguration<>));
                var baseTypesToRegister = typesToRegister.Select(type => type.BaseType);
                ...
                var entityTypes = assembly.GetTypes().Where(t => t.BaseType == typeof(Entity) && !t.GetInterfaces().Contains(typeof(INotMappedEntity)) &&
                    !baseTypesToRegister.Any(entityConfiguratioBaseType => entityConfiguratioBaseType == t)).ToArray();
